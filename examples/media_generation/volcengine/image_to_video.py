...
def execute():
    request = ImageToVideoRequest(
        ...
        model=common.env_string('MEDIA_VOLCENGINE_VIDEO_MODEL'),
        duration=DURATION,
    ...
    with common.media_client(ModelProvider.VOLCENGINE, 'video') as media:
        return common.complete_result(media, media.video.from_image(request, provider=ModelProvider.VOLCENGINE))
