...
def execute():
    request = TextToSpeechRequest(
        text=TEXT,
        model=common.env_string('MEDIA_HIFLY_SPEECH_MODEL', required=True),
    ...
    with common.media_client(ModelProvider.HIFLY, 'speech') as media:
        return common.complete_result(media, media.speech.synthesize(request, provider=ModelProvider.HIFLY))
